...
> **Standard of reference**: the calculator follows the logic of the **EN 15316-1** for heating systems and supports 4 types of emission circuits (C.2, C.3, C.4, C.5).
